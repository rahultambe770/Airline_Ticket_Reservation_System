...
//-----------------------------------new methods------------------------------
	...
	@Override
	public Optional<BookingDetails> getBookingByBookingId(Integer BookingId) {
		Optional<BookingDetails> booking =bookingDao.findById(BookingId);
		if (!booking.isPresent()) {
			throw new UserDoesnotExistException("booking id not found");
		}
		return booking;
